...
export default {
  ...
  mounted() {
    this.loading = true
    if (sessionStorage.getItem('humidityXdata') !== null) {
    ...
    initChart() {
      ...
      this.chart.setOption({
        ...
        series: [{
          ...
          areaStyle: {
            normal: {
              color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                offset: 0,
                color: 'rgba(147, 171, 198, 0.3)'
              }, {
                offset: 0.8,
                color: 'rgba(147, 171, 198, 0)'
              }], false),
          ...
          itemStyle: {
            normal: {
              color: 'rgb(147, 171, 198)',
              borderColor: 'rgba(147, 171, 198,0.2)',
              borderWidth: 12
            }
          },
