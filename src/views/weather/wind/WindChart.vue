...
export default {
  ...
  mounted() {
    this.loading = true
    if (sessionStorage.getItem('windXdata') !== null) {
    ...
    initChart() {
      ...
      this.chart.setOption({
        ...
        legend: {
          ...
          itemHeight: 5,
          itemGap: 13,
          data: ['预测风速(windSpeed)', '实际风速(ROUND(A.WS,1))'],
          right: '4%',
          textStyle: {
            fontSize: 12,
            color: '#F1F1F3'
        ...
        series: [{
          ...
          areaStyle: {
            normal: {
              color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                offset: 0,
                color: 'rgba(165, 174, 190, 0.3)'
              }, {
                offset: 0.8,
                color: 'rgba(165, 174, 190, 0)'
              }], false),
          ...
          itemStyle: {
            normal: {
              ...
              borderColor: 'rgba(165, 174, 190,0.2)',
              borderWidth: 12
